...
>
> **История handovers:** при закрытии каждого спринта этот файл перезаписывается актуальной версией. Архив предыдущих в [`archive/`](archive/):
> - [OPUS_HANDOVER_SPRINT_0.md](archive/OPUS_HANDOVER_SPRINT_0.md) — Sprint 0 → Sprint 1 (отправлен Opus'у 16 мая)
